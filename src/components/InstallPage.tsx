      ...
      case 'migration-needed':
        return (
          <div className="text-center">
            ...
            <div className="bg-gray-900 border border-gray-600 rounded-xl p-4 mb-6">
...
ON CONFLICT DO NOTHING;`}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                className="flex-1 bg-gray-700 text-gray-300 py-3 px-6 rounded-xl font-semibold hover:bg-gray-600 transition-colors border border-gray-600 flex items-center justify-center gap-2"
              >
